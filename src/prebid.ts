...
declare module './prebidGlobal' {
  interface PrebidJS {
    ...
    findBidByAdId: typeof findBidByAdId; // YMPB
  }
}
...
function findBidByAdId (adId: string): Partial<Bid> | null {
  const bid = auctionManager.findBidByAdId(adId) as Bid | null;
  if (bid) {
...
// YMPB
addApiMethod('findBidByAdId', findBidByAdId);
